...
describe("WordSearch", function() {
	...
	it("should solve the word UHURA", function() {
	...
	it("should solve the entire puzzle", function() {
		expect(wordSearch._solvePuzzle()).toEqual({ BONES : [ [ 0, 6 ], [ 0, 7 ], [ 0, 8 ], [ 0, 9 ], [ 0, 10 ] ], KHAN : [ [ 5, 9 ], [ 5, 8 ], [ 5, 7 ], [ 5, 6 ] ], KIRK : [ [ 4, 7 ], [ 3, 7 ], [ 2, 7 ], [ 1, 7 ] ], SCOTTY : [ [ 0, 5 ], [ 1, 5 ], [ 2, 5 ], [ 3, 5 ], [ 4, 5 ], [ 5, 5 ] ], SPOCK : [ [ 2, 1 ], [ 3, 2 ], [ 4, 3 ], [ 5, 4 ], [ 6, 5 ] ], SULU : [ [ 3, 3 ], [ 2, 2 ], [ 1, 1 ], [ 0, 0 ] ], UHURA : [ [ 4, 0 ], [ 3, 1 ], [ 2, 2 ], [ 1, 3 ], [ 0, 4 ] ] });
	});
	it("should solve the entire puzzle in the desired output format", function() {
		expect(wordSearch.solvePuzzle()).toEqual("BONES:	(0,6),(0,7),(0,8),(0,9),(0,10)\nKHAN:	(5,9),(5,8),(5,7),(5,6)\nKIRK:	(4,7),(3,7),(2,7),(1,7)\nSCOTTY:	(0,5),(1,5),(2,5),(3,5),(4,5),(5,5)\nSPOCK:	(2,1),(3,2),(4,3),(5,4),(6,5)\nSULU:	(3,3),(2,2),(1,1),(0,0)\nUHURA:	(4,0),(3,1),(2,2),(1,3),(0,4)");
	});

	// End tests with actual provided sample data
});
